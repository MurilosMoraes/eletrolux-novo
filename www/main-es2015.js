...
const routes = [
    ...
    {
        path: 'preliminary',
        loadChildren: () => __webpack_require__.e(/*! import() | preliminary-preliminary-module */ "preliminary-preliminary-module").then(__webpack_require__.bind(null, /*! ./preliminary/preliminary.module */ "./src/app/preliminary/preliminary.module.ts")).then(m => m.PreliminaryPageModule)
    },
    {
        path: 'record',
        loadChildren: () => __webpack_require__.e(/*! import() | record-record-module */ "record-record-module").then(__webpack_require__.bind(null, /*! ./record/record.module */ "./src/app/record/record.module.ts")).then(m => m.RecordPageModule)
    },
    {
        path: 'justification',
        loadChildren: () => __webpack_require__.e(/*! import() | justification-justification-module */ "justification-justification-module").then(__webpack_require__.bind(null, /*! ./justification/justification.module */ "./src/app/justification/justification.module.ts")).then(m => m.JustificationPageModule)
    },
    {
        path: 'questionnaire',
        loadChildren: () => __webpack_require__.e(/*! import() | questionnaire-questionnaire-module */ "questionnaire-questionnaire-module").then(__webpack_require__.bind(null, /*! ./questionnaire/questionnaire.module */ "./src/app/questionnaire/questionnaire.module.ts")).then(m => m.QuestionnairePageModule)
    },
    {
        path: 'loading',
        loadChildren: () => __webpack_require__.e(/*! import() | loading-loading-module */ "loading-loading-module").then(__webpack_require__.bind(null, /*! ./loading/loading.module */ "./src/app/loading/loading.module.ts")).then(m => m.LoadingPageModule)
    },
    {
        path: 'text',
        loadChildren: () => __webpack_require__.e(/*! import() | text-text-module */ "text-text-module").then(__webpack_require__.bind(null, /*! ./text/text.module */ "./src/app/text/text.module.ts")).then(m => m.TextPageModule)
    },
    {
        path: 'menu',
    ...
    {
        path: 'section',
        loadChildren: () => __webpack_require__.e(/*! import() | section-section-module */ "section-section-module").then(__webpack_require__.bind(null, /*! ./section/section.module */ "./src/app/section/section.module.ts")).then(m => m.SectionPageModule)
    },
];
...
module.exports = __webpack_require__(/*! /Users/fauzihalabe/Desktop/Electrolux-main/src/main.ts */"./src/main.ts");
